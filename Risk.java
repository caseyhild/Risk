...
public class Risk extends JPanel implements ActionListener, MouseListener, MouseMotionListener, KeyListener
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        else if(gameState.equals("play"))
        {
            ...
            if(selectedRow >= 0 && selectedCol >= 0)
            {
                ...
                g.drawString(players[board[selectedRow][selectedCol]].getArmies(selectedRow, selectedCol) + " armies", width/30 + height/10 + height/60, 2 * height/3 + height/40 + fm.getAscent()/2 - 1);
                g.drawString("Controlled by " + players[board[selectedRow][selectedCol]].getName(), width/30 + height/10 + height/60, 2 * height/3 + 3 * height/40 + fm.getAscent()/2 - 1);
            }
            if(mode.equals("deploy"))
            {
                ...
                {
                    ((Human) players[1]).deploy(selectedRow, selectedCol, 1);
                }
                if(mouseClicked && selectedRow >= 0 && selectedCol >= 0 && board[selectedRow][selectedCol] == 1 && mouseX >= width - (height - topBorder - border) + (height - topBorder - 2 * border) * selectedCol/size && mouseX <= width - (height - topBorder - border) + (height - topBorder - 2 * border) * (selectedCol + 1)/size && mouseY >= topBorder + border + (height - topBorder - 2 * border) * selectedRow/size && mouseY <= topBorder + border + (height - topBorder - 2 * border) * (selectedRow + 1)/size)
                {
                    ...
                    for(int r = 0; r < size; r++)
                    {
                        for(int c = 0; c < size; c++)
                        {
                            if(((Human) players[1]).getArmies(r, c) - armiesCopy[r][c] > 0 && !(selectedRow == r && selectedCol == c))
                                numAlreadyDeployed += ((Human) players[1]).getArmies(r, c) - armiesCopy[r][c];
                        }
                    }
                    numAvailable = ((Human) players[1]).getArmiesPerTurn() - numAlreadyDeployed;
                    numDeployedString = "" + (((Human) players[1]).getArmies(selectedRow, selectedCol) - armiesCopy[selectedRow][selectedCol]);
            ...
            else if(mode.equals("attack"))
            {
                ...
                if(mouseClicked && !selectArmiesScreen && showAttackArrows && attackingRow >= 0 && attackingCol >= 0 && !(selectedRow == attackingRow && selectedCol == attackingCol) && connected(selectedRow, selectedCol, attackingRow, attackingCol))
                {
                    ...
                    numAvailable = ((Human) players[1]).getArmies(attackingRow, attackingCol) - numAlreadyAttacking;
    ...
    public void startGame()
    {
        ...
        {
            attacks[i] = new ArrayList<Attack>();
        }
    ...
    {
        int[] x = {
                width - (height - topBorder) + border + ((height - topBorder) - 2 * border) * col1/size + ((height - topBorder) - 2 * border)/size/2 + (int) (10 * Math.cos(Math.toRadians(angle))) - (int) (5 * Math.sin(Math.toRadians(angle))),
                width - (height - topBorder) + border + ((height - topBorder) - 2 * border) * col1/size + ((height - topBorder) - 2 * border)/size/2 + (int) (10 * Math.cos(Math.toRadians(angle))) + (int) (5 * Math.sin(Math.toRadians(angle))),
                width - (height - topBorder) + border + ((height - topBorder) - 2 * border) * col2/size + ((height - topBorder) - 2 * border)/size/2 - (int) (30 * Math.cos(Math.toRadians(angle))) + (int) (5 * Math.sin(Math.toRadians(angle))),
                width - (height - topBorder) + border + ((height - topBorder) - 2 * border) * col2/size + ((height - topBorder) - 2 * border)/size/2 - (int) (30 * Math.cos(Math.toRadians(angle))) + (int) (10 * Math.sin(Math.toRadians(angle))),
                width - (height - topBorder) + border + ((height - topBorder) - 2 * border) * col2/size + ((height - topBorder) - 2 * border)/size/2 - (int) (10 * Math.cos(Math.toRadians(angle))),
                width - (height - topBorder) + border + ((height - topBorder) - 2 * border) * col2/size + ((height - topBorder) - 2 * border)/size/2 - (int) (30 * Math.cos(Math.toRadians(angle))) - (int) (10 * Math.sin(Math.toRadians(angle))),
                width - (height - topBorder) + border + ((height - topBorder) - 2 * border) * col2/size + ((height - topBorder) - 2 * border)/size/2 - (int) (30 * Math.cos(Math.toRadians(angle))) - (int) (5 * Math.sin(Math.toRadians(angle))),
            };
        int[] y = {
                topBorder + border + ((height - topBorder) - 2 * border) * row1/size + ((height - topBorder) - 2 * border)/size/2 - (int) (10 * Math.sin(Math.toRadians(angle))) - (int) (5 * Math.cos(Math.toRadians(angle))),
                topBorder + border + ((height - topBorder) - 2 * border) * row1/size + ((height - topBorder) - 2 * border)/size/2 - (int) (10 * Math.sin(Math.toRadians(angle))) + (int) (5 * Math.cos(Math.toRadians(angle))),
                topBorder + border + ((height - topBorder) - 2 * border) * row2/size + ((height - topBorder) - 2 * border)/size/2 + (int) (30 * Math.sin(Math.toRadians(angle))) + (int) (5 * Math.cos(Math.toRadians(angle))),
                topBorder + border + ((height - topBorder) - 2 * border) * row2/size + ((height - topBorder) - 2 * border)/size/2 + (int) (30 * Math.sin(Math.toRadians(angle))) + (int) (10 * Math.cos(Math.toRadians(angle))),
                topBorder + border + ((height - topBorder) - 2 * border) * row2/size + ((height - topBorder) - 2 * border)/size/2 + (int) (10 * Math.sin(Math.toRadians(angle))),
                topBorder + border + ((height - topBorder) - 2 * border) * row2/size + ((height - topBorder) - 2 * border)/size/2 + (int) (30 * Math.sin(Math.toRadians(angle))) - (int) (10 * Math.cos(Math.toRadians(angle))),
                topBorder + border + ((height - topBorder) - 2 * border) * row2/size + ((height - topBorder) - 2 * border)/size/2 + (int) (30 * Math.sin(Math.toRadians(angle))) - (int) (5 * Math.cos(Math.toRadians(angle)))
            };
        g.setColor(color);
    ...
    public void drawDeployArmiesScreen(Graphics g)
    {
        ...
        if(mousePressed && !draggingArmiesAmount && mouseX >= deployArmiesScreenX + width/8 - height/60 - fm.stringWidth("0")/4 && mouseX <= deployArmiesScreenX + width/8 - fm.stringWidth("0")/4 + fm.stringWidth("000000000") && mouseY >= deployArmiesScreenY + height/16 - 9 * fm.getAscent()/16 && mouseY <= deployArmiesScreenY + height/16 + 9 * fm.getAscent()/16)
            cursorPos = (int) Math.round(1.0 * (mouseX - deployArmiesScreenX + width/8 + fm.stringWidth("0")/4)/fm.stringWidth("0")) + 1;
        ...
        if(!numDeployedString.equals("") && numDeployedString.length() < 10)
        ...
        int deployed = 0;
        if(!numDeployedString.equals(""))
            deployed = Math.max(0, Math.min(Integer.parseInt(numDeployedString), numAvailable));
        if(mousePressed && Math.hypot(mouseX - (deployArmiesScreenX - 5 * width/64 + (int) (5 * width/32.0 * deployed/numAvailable)), mouseY - deployArmiesScreenY) < height/120)
            draggingArmiesAmount = true;
        if(!mousePressed)
            draggingArmiesAmount = false;
        if(draggingArmiesAmount)
        {
            numDeployedString = "" + Math.max(0, Math.min((int) Math.round((1.0 * (mouseX - (deployArmiesScreenX - 5 * width/64))/(5 * width/32)) * numAvailable), numAvailable));
            cursorPos = numDeployedString.length();
        ...
        ((Human) players[1]).setArmies(selectedRow, selectedCol, armiesCopy[selectedRow][selectedCol] + deployed);
        if(Math.hypot(mouseX - (deployArmiesScreenX + 3 * width/32 - height/30), mouseY - (deployArmiesScreenY - 3 * height/32 + height/30)) < height/60)
            g.setColor(new Color(32, 32, 32));
        else
            g.setColor(new Color(64, 64, 64));
        ...
        g.drawLine(deployArmiesScreenX + 3 * width/32 - height/30 + height/120 - 1, deployArmiesScreenY - 3 * height/32 + height/30 - height/120, deployArmiesScreenX + 3 * width/32 - height/30 - height/120, deployArmiesScreenY - 3 * height/32 + height/30 + height/120 - 1);
        g.drawLine(deployArmiesScreenX + 3 * width/32 - height/30 + height/120, deployArmiesScreenY - 3 * height/32 + height/30 - height/120 + 1, deployArmiesScreenX + 3 * width/32 - height/30 - height/120 + 1, deployArmiesScreenY - 3 * height/32 + height/30 + height/120);
        if(mouseClicked && Math.hypot(mouseX - (deployArmiesScreenX + 3 * width/32 - height/30), mouseY - (deployArmiesScreenY - 3 * height/32 + height/30)) < height/60)
        {
            deployArmiesScreen = false;
            draggingScreen = false;
        ...
        else if(mousePressed && mouseX >= deployArmiesScreenX - 3 * width/32 && mouseX <= deployArmiesScreenX + 3 * width/32 && mouseY >= deployArmiesScreenY - 3 * height/32 && mouseY <= deployArmiesScreenY + 3 * height/32 && !draggingArmiesAmount && Math.hypot(mouseX - (deployArmiesScreenX - 5 * width/64 + (int) (5 * width/32.0 * deployed/numAvailable)), mouseY - deployArmiesScreenY) >= height/120)
        {
            if(!draggingScreen)
            {
    ...
    public void drawSelectArmiesScreen(Graphics g)
    {
        ...
        if(mousePressed && !draggingArmiesAmount && mouseX >= 5 * width/8 - height/60 - fm.stringWidth("0")/4 && mouseX <= 5 * width/8 - fm.stringWidth("0")/4 + fm.stringWidth("000000000") && mouseY >= 9 * height/16 - 9 * fm.getAscent()/16 && mouseY <= 9 * height/16 + 9 * fm.getAscent()/16)
            cursorPos = (int) Math.round(1.0 * (mouseX - 5 * width/8 + fm.stringWidth("0")/4)/fm.stringWidth("0")) + 1;
        cursorPos = Math.max(0, Math.min(cursorPos, numAttackingString.length()));
        numAttacking = 0;
        if(!numAttackingString.equals("") && numAttackingString.length() < 10)
        ...
        if(mousePressed && Math.hypot(mouseX - (3 * width/8 - height/12 + (int) (width/4.0 * numAttacking/numAvailable)), mouseY - 9 * height/16) < height/120)
            draggingArmiesAmount = true;
        if(!mousePressed)
            draggingArmiesAmount = false;
        if(draggingArmiesAmount)
        {
            numAttackingString = "" + Math.max(0, Math.min((int) Math.round((1.0 * (mouseX - (3 * width/8 - height/12))/(width/4)) * numAvailable), numAvailable));
            cursorPos = numAttackingString.length();
        }
        g.setColor(new Color(128, 128, 128));
        ...
        if(Math.hypot(mouseX - (3 * width/4 - height/30), mouseY - (height/4 + height/30)) < height/60)
            g.setColor(new Color(32, 32, 32));
        else
            g.setColor(new Color(64, 64, 64));
        ...
        g.drawLine(3 * width/4 - height/30 - height/120, height/4 + height/30 - height/120, 3 * width/4 - height/30 + height/120, height/4 + height/30 + height/120);
        g.drawLine(3 * width/4 - height/30 - height/120 + 1, height/4 + height/30 - height/120, 3 * width/4 - height/30 + height/120, height/4 + height/30 + height/120 - 1);
        g.drawLine(3 * width/4 - height/30 - height/120, height/4 + height/30 - height/120 + 1, 3 * width/4 - height/30 + height/120 - 1, height/4 + height/30 + height/120);
        g.drawLine(3 * width/4 - height/30 + height/120, height/4 + height/30 - height/120, 3 * width/4 - height/30 - height/120, height/4 + height/30 + height/120);
        g.drawLine(3 * width/4 - height/30 + height/120 - 1, height/4 + height/30 - height/120, 3 * width/4 - height/30 - height/120, height/4 + height/30 + height/120 - 1);
        g.drawLine(3 * width/4 - height/30 + height/120, height/4 + height/30 - height/120 + 1, 3 * width/4 - height/30 - height/120 + 1, height/4 + height/30 + height/120);
        ...
        else if(mouseClicked && Math.hypot(mouseX - (3 * width/4 - height/30), mouseY - (height/4 + height/30)) < height/60)
        {
            selectArmiesScreen = false;
            selectArmiesScreenClosed = true;
            numAttacking = -1;
    ...
    public void setAIDeployments()
    {
        for(int i = 1; i < numPlayers; i++)
        {
            ...
            for(int k = 0; k < ((AI) players[i + 1]).getArmiesPerTurn(); k++)
            {
                ...
                ((AI) players[i + 1]).deploy(rows[random], cols[random], 1);
            }
        }
    }
    ...
    public void setAIAttacks()
    {
        for(int i = 1; i < numPlayers; i++)
        {
            for(int r = 0; r < size; r++)
            {
                for(int c = 0; c < size; c++)
                {
                    if(((AI) players[i + 1]).getArmies(r, c) > 0)
                    {
